...
/**
 * Render the Clients page UI, manage client-group state, and handle related data fetching and interactions.
 *
 * Renders a dashboard with client-group statistics, a searchable table of client groups, column visibility controls,
 * and a multi-step wizard for creating new client groups. Manages fetching and caching of client groups, GoHighLevel
 * locations, and Meta ad accounts; maintains local UI state (filters, selections, column visibility, custom metrics,
 * and user currency) and performs optimistic updates when creating client groups.
 *
 * @returns {JSX.Element} The Clients page React component tree.
 */
