      ...
      <body suppressHydrationWarning>
          <ProtectedLayout>
            <SidebarProvider open={false} >
              ...
              <SidebarInset>
                {!hideSidebar && (
                  <header className=" bg-white w-full z-50 top-0 flex h-12 shrink-0 items-center gap-2 border-b px-0 md:px-4 md:hidden">
                ...
                <div id="do not change the width" className="w-full mx-auto flex flex-1 flex-col gap-4 p-0 md:p-7 overflow-x-clip">
                  {children}
                </div>
              </SidebarInset>
            </SidebarProvider>
